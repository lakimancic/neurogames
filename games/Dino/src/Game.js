...
export default class Game {
    ...
    async load() {
        ...
        this.sprites['cloud'] = await loadImage('./assets/cloud.png');
        this.sprites['big_cactus'] = await loadImage('./assets/big_cactus.png');
        this.sprites['small_cactus'] = await loadImage('./assets/small_cactus.png');
        this.sprites['dino'] = await loadImage('./assets/dino.png');
        this.sprites['gameover'] = await loadImage('./assets/gameover.png');
        this.sprites['numbers'] = await loadImage('./assets/numbers.png');
        this.sprites['reset'] = await loadImage('./assets/reset.png');
